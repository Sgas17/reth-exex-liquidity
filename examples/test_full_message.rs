...
fn main() {
    ...
    let pool_addr: Address = "0x8ad599c3a0ff1de082011efddc58f1908eb6e6d8"
        .parse()
        .unwrap();
    ...
    let pool_id_disc = u32::from_le_bytes([
        bytes[offset],
        bytes[offset + 1],
        bytes[offset + 2],
        bytes[offset + 3],
    ...
    println!(
        "  [{}-{}] PoolIdentifier discriminant: {} (Address)",
        offset,
        offset + 3,
        pool_id_disc
    );
    ...
    println!(
        ...
        offset,
        offset + 19,
        hex::encode(&bytes[offset..offset + 20])
    );
    offset += 20;
    ...
    // UpdateType (u32)
    let update_type = u32::from_le_bytes([
        bytes[offset],
        bytes[offset + 1],
        bytes[offset + 2],
        bytes[offset + 3],
    ...
    let pool_update_disc = u32::from_le_bytes([
        bytes[offset],
        bytes[offset + 1],
        bytes[offset + 2],
        bytes[offset + 3],
    ...
    println!(
        "  [{}-{}] PoolUpdate discriminant: {} (V3Swap)",
        offset,
        offset + 3,
        pool_update_disc
    );
    ...
    // Test V2 Swap
    println!("\nV2 Swap test:");
    let v2_pool: Address = "0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc"
        .parse()
        .unwrap();
